...
reported privately to the maintainer by [opening a draft security
advisory](../../security/advisories/new) on this repository — it is visible
only to the maintainer, and works for conduct reports as well as security
ones. If you would rather not use that, or the report concerns the maintainer,
use [GitHub's abuse reporting
form](https://support.github.com/contact/report-abuse).
